...
async function exportQueryChartA4Png(){
  ...
  const headerPlugin = {
    ...
    beforeDraw(chartInstance){
      ...
      ctx.save();
      // White background for export (avoid dark/transparent PNG on iOS viewers)
  ...
  const cfg = {
    ...
    options: {
      ...
      layout: { padding: { top: 170, left: 70, right: 70, bottom: 70 } },
      plugins: {
        legend: { display: true, labels: { color: "#111", font: { size: 20 } } },
