...
async function exportQueryChartA4Png(){
  ...
  // A4 landscape at 300 DPI: 3508 x 2480 px
  const W = 3508, H = 2480;
  ...
  // Create an offscreen canvas so we don't disturb the on-screen chart
  ...
  // Wait a tick to ensure it has rendered
  await new Promise(r=>setTimeout(r, 50));

  const filename = `stock-ledger_chart_${sym}_${yyyy}${mm}${dd}.png`;

  // Prefer Share Sheet on iOS if available
